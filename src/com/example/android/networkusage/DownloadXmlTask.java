...
import com.example.android.networkusage.NewsYCombinatorParser.Entry;
...
public class DownloadXmlTask extends AsyncTask<String, Void, String> {
    ...
    private String loadXmlFromNetwork(String urlString)
        ...
        NewsYCombinatorParser newscombinatorXmlParser = new NewsYCombinatorParser();
        ...
        // NewsYCombinatorParser
        // returns a List (called "entries") of Entry
        // objects.
        ...
        for (Entry entry : entries) {
            ...
            Log.d(DEBUG_TAG, "Mobile content from the app was updated");
        }
