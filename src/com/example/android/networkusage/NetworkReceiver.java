	...
	public void onReceive(Context context, Intent intent) {
		...
		if (NetworkActivity.WIFI.equals(mNetworkActivity.getsPref())
			...
			Toast.makeText(context, R.string.wifi_connected, Toast.LENGTH_SHORT)
					.show();
			Log.d(DEBUG_TAG, "Devices has its Wifi connnection, refeshDisplay => true");
			...
			NetworkActivity.setRefreshDisplay(false);
			Toast.makeText(context, R.string.lost_connection,
					Toast.LENGTH_SHORT).show();
			Log.d(DEBUG_TAG, "Devices has another connnection, refeshDisplay => false");
		}
	}
